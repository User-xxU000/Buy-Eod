...
st.set_page_config(page_title="Serial Codes End Of Dragons Buy Now")


st.title("""¡End Of Dragons - Serial Codes!""")
#layouts

col1,col2,col3 = st.columns(3)
with col3:
    st.subheader("""End Of Dragons Serial Codes""",)
...
with col1:
    image = st.image("Photogame.jpg", width=400)
